...
export KUBE_CONFIG_LOCATION="/Users/bhutwala/.kube"
export KIND_CLUSTER_NAME="kind-v1.15.3-multi-node-cluster"

# create the kind cluster
kind create cluster --config ${KIND_CLUSTER_NAME}.yml --name ${KIND_CLUSTER_NAME}
